...
import { getChickenBatches, getEggRecords } from '@/actions/production.actions';
import { EggFried, ArrowLeft, History } from 'lucide-react';
    ...
    <div className="p-4 md:p-8 max-w-7xl mx-auto flex flex-col gap-8 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-5">
           <EggProductionForm batches={batches || []} />
        </div>
        ...
        <div className="lg:col-span-7 bg-white p-6 rounded-3xl shadow-sm border border-gray-100 flex flex-col gap-6">
          <div className="flex items-center justify-between">
            ...
            <span className="bg-amber-50 text-amber-600 px-3 py-1 rounded-lg text-xs font-bold">Ultimos 50</span>
          </div>
            ...
            <table className="w-full text-sm text-left">
              <thead className="bg-gray-50 text-gray-600 font-bold uppercase text-xs tracking-wider">
                <tr>
                  ...
                  <th className="px-6 py-4 text-right rounded-tr-xl">Huevos</th>
                </tr>
              </thead>
